...
const FIL = {
  ...
  'Loading the recipe book…': 'Binubuksan ang recipe book…',
  'Could not load the recipes.': 'Hindi ma-load ang mga recipe.',
  'Check your connection and reload the page.': 'I-check ang connection mo tapos i-reload ang page.',
  Reload: 'I-reload',
  'Show {n} more': 'Magpakita pa ng {n}',
  ...
  'from {count} ratings': 'mula sa {count} rating',
  Easy: 'Madali',
  Medium: 'Medium',
  Hard: 'Mahirap',
  ...
  'Bilo-Bilo': 'Bilo-bilo',
  Kofta: 'Kofta',
  'Spiced water': 'Spiced water (pani)',
  Tare: 'Tare',
  Base: 'Base',
  'Pork Topping': 'Pork topping',
  'Soy Milk': 'Soy milk',
  Adobo: 'Adobo',
  Sofrito: 'Sofrito',
